...
namespace rst
{
    ...
    public:
        ...
        void draw(pos_buf_id pos_buffer, ind_buf_id ind_buffer, col_buf_id col_buffer, Primitive type, bool superSampling);
    ...
    private:
        ...
        void rasterize_triangle(const Triangle& t, bool superSampling);
